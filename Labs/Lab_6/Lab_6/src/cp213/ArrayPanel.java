...
public class ArrayPanel extends JPanel {
    ...
    // ---------------------------------------------------------------------
    /**
     * An inner class that uses an ActionListener to access <code>showButton</code>.
     * It displays the result of the array search when pressed and catches any input
     * and search errors.
     */
	...
	public void actionPerformed(ActionEvent evt) {
		...
		JOptionPane.showMessageDialog(null, "Bad Number: Use Integers Only", "Error",
			JOptionPane.ERROR_MESSAGE);
	    } catch (ArrayIndexOutOfBoundsException e) {
		// Catch the array boundary exception.
		JOptionPane.showMessageDialog(null, "Not a valid array index", "Error", JOptionPane.ERROR_MESSAGE);
	    } catch (Exception e) {
