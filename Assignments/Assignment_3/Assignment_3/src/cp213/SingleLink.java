...
public abstract class SingleLink<T> implements Iterable<T> {
	...
	SingleNode<T> this_front = this.front;
	SingleNode<T> source_front = source.front;

	source.front = source.front.getNext();

	this.front = source_front;
	this.front.setNext(this_front);
	...
	if (this.rear != null) {
	    ...
	    this.rear.setNext(source_front);
	    this.rear = source_front;
